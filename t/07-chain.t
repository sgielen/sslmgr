...
$ssl->create("www.simple.com.crt", content => simple_crt());
$ssl->create("www.example.com.key", content => example_key());
$ssl->create("www.example.com.crt", content => example_crt());
...
my $build_result = {Sslmgr::build_chain($ssl->path, $root->path, "www.simple.com")};
...
$ssl->mkdir(".intermediary");
$ssl->create(".intermediary/1987cbba.crt", content => intermediary_crt());
$build_result = {Sslmgr::build_chain($ssl->path, $root->path, "www.example.com")};
